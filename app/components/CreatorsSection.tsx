...
export default function CreatorsSection() {
  ...
  const getcreator = async () => {
    try {
      ...
      setCreators(res.data?.processedCreators);
      console.log(res.data?.processedCreators);
    } catch (error) {
  ...
  const creator = [
    {
      id: 1,
      name: creators[0]?.creatorName,
      image: creators[0]?.creatorImage,
      size: 100,
      position: { desktop: { top: "25px", left: "90px" } }, // Adjust these values
    },
    {
      id: 2,
      name: creators[1]?.creatorName,
      image: creators[1]?.creatorImage,
      size: 150,
      position: { desktop: { top: "130px", left: "240px" } },
    },
    {
      id: 3,
      name: creators[2]?.creatorName,
      image: creators[2]?.creatorImage,
      size: 115,
      position: { desktop: { top: "15px", left: "415px" } },
    },
    {
      id: 4,
      name: creators[3]?.creatorName,
      image: creators[3]?.creatorImage,
      size: 135,
      position: { desktop: { top: "80px", left: "565px" } },
    },
    {
      id: 5,
      name: creators[4]?.creatorName,
      image: creators[4]?.creatorImage,
      size: 145,
      position: { desktop: { top: "20px", right: "400px" } },
    },
    {
      id: 6,
      name: creators[5]?.creatorName,
      image: creators[5]?.creatorImage,
      size: 130,
      position: { desktop: { top: "145px", right: "250px" } },
    },
    {
      id: 7,
      name: creators[6]?.creatorName,
      image: creators[6]?.creatorImage,
      size: 120,
      position: { desktop: { top: "25px", right: "110px" } },
    },
  ];
  useEffect(() => {
    controls.start({
      ...
      {creators.length > 0 && (
        <section className="container mx-auto my-6 relative pp:space-y-12 space-y-6">
          ...
          <div className="hidden xl:block relative h-[300px]">
            ...
            <svg
              className="absolute -top-0 -left-22 w-[1420px] h-full"
              height="299"
              width="1442"
              fill="none"
          ...
          {creators.length > 0 && (
            <div className="xl:hidden overflow-hidden relative h-[140px]">
              <motion.div
                ...
                style={{
                  width: `${creators.length * 2 * 110}px`, // 110 = 90px image + 20px spacing
                }}
              >
